...
from npdna.atulya_core.schema.models import TantraRequest, TantraResponse, Message, RequestContext
    ...
    def __init__(self, personality_config: Optional[Dict] = None):
        if personality_config is None:
            ...
            config_path = os.path.abspath(
                os.path.join(os.path.dirname(__file__), "..", "fusion_config", "personality_config.json")
            )
