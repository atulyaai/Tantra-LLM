#!/usr/bin/env python3
"""
Test script for different weight file formats
"""
...
def test_weight_formats():
    """Test loading weights in different formats"""
    print("Testing weight file formats...")
    print("=" * 50)
...
def test_file_sizes():
    """Test file sizes for different formats"""
    print(f"\n{'='*50}")
