...
class LazyExpertLoader:
    ...
    def _load_expert(self, expert_id: int) -> nn.Module:
        ...
        if self._registry.exists_on_disk(expert_id):
            ...
            # (In a real implementation, you'd unflatten state_dict_flat into the model's parameters)
            # Here we just simulate loading the weights.
            pass
        else:
    ...
    def save_all_active_experts() -> None:
